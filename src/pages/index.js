...
class Index extends React.Component {
  ...
  componentDidMount() {
    this.setState = {
      featuredSample = _.sampleSize(props.data.all.edges, 3)
      artSample = _.sampleSize(props.data.art.edges, 4)
      essaySample = _.sampleSize(props.data.personalessay.edges, 3)
      fictionSample = _.sampleSize(props.data.fiction.edges, 3)
      poetrySample = _.sampleSize(props.data.poetry.edges, 3)
    }
  }

  render() {
    const { featuredSample, artSample, essaySample, fictionSample, poetrySample } = this.state;
    return (
